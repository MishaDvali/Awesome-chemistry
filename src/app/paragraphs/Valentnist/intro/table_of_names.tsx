...
const ChemicalTable: React.FC = ({}) => {
	const data = [
		...
		["S", -2, "сульфід", "CaS", "кальцій сульфід"],
		["F", -1, "фторид", "FeF3", "ферум (III) фторид"],
		["Cl", -1, "хлорид", "SrCl2", "стронцій хлорид"],
		["Br", -1, "бромід", "CuBr2", "купрум (II) бромід"],
		["I", -1, "йодид", "NaI", "натрій йодид"],
		["N", -3, "нітрид", "K3N", "калій нітрид"],
		["P", -3, "фосфіл", "Mg3P2", "магній фосфід"],
		["C", -4, "карбід", "*CaC2", "кальцій карбід"],
